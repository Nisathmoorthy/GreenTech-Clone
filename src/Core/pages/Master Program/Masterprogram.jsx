import MasterStyle from "./Masterprogram.module.css";
...
function Masterprogram() {
  return (
    <div>
      <div>
        <img src={Call} className={MasterStyle.call} />
      ...
      <div className={MasterStyle.menubar2}>
        <ul>
          <li>
            <img src={Logo} />
          </li>
          <li>
            <a href="#">
              <button className={MasterStyle.button1}>Courses</button>
            </a>
          </li>
          <li>
          ...
          <li>
          <Link to="/contact"><button className={MasterStyle.button2}>CONTACT US</button></Link>     
          </li>
        </ul>
      </div>
      ...
      <div className={MasterStyle.gridcontainer22}>
        <div className={MasterStyle.gridd1}>
          <img src={Advance} />
      ...
      <div className={MasterStyle.secondContainer}>
        <div className={MasterStyle.content1}>
          <h3>
          ...
          <div className={MasterStyle.gridcontainer33}>
            <div className={MasterStyle.griditem33}>
              <img src={Location}/>
      ...
      <div className={MasterStyle.thirdContainer}>
        <div className={MasterStyle.content}>
          <h3>
          HOW WE WORK
          </h3>
          <p>
      ...
      <div className={MasterStyle.footer}>
        <div className={MasterStyle.gridcontainer}>
          <div className={MasterStyle.grid1}>
            <h6>
